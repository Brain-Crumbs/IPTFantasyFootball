...
- **Current implementation task: BOOT-023 — GitHub Actions CI enforcement / issue #25**
- Canonical BOOT-023 branch: `bootstrap/boot-023-ci-enforcement`
...
Later BOOT issues own those capabilities and must not be pulled into BOOT-013, BOOT-016, BOOT-018, BOOT-019, BOOT-020, BOOT-021, BOOT-022, or BOOT-023.
